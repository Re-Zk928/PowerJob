...
public class FourthClass implements BasicProcessor {
    ...
    public ProcessResult process(TaskContext context) throws Exception {
        ...
        context.getOmsLogger().info("Fourth 获取到数据：{}", dataFromFirst);
        return new ProcessResult(true,"Fourth 任务执行完成，收到数据：" + dataFromFirst );
